    ...
    // Mendapatkan solusi SPL dengan metode Eliminasi Gauss
    {
        ...
        if (isSolExist(m)) // SPL memiliki solusi
        {
            ...
            for (i = m.getlastRowIdx(); i >= 0; i--) 
            {
                ...
                if (idx_col != (-1))
                {   
                    // inisialisasi Row_Temp untuk nilai sementara di baris yang akan dicari solusinya
                    ...
                    // Inisialisasi variabel yang dicari solusinya dengan elemen terakhir di barisnya
            ...
            for (i = 0; i < m.getlastColIdx(); i++) 
            {
                ...
                if (Solution[i] == null) 
                {
                    Solution[i] = Solution[i] = "X" + (i+1) + " = " + Parametrik[i] + ", dengan " + Parametrik[i] + " bilangan Real.";
                }
